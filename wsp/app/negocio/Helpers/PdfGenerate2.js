function generate(res) {
    ...
    var detail = function (rpt, data) {
        rpt.band([
            ...
            {
                data: data.hundredtwenty,
                width: 60,
                align: 3
            },
            {
                data: data.sale.balance_due,
                width: 60,
                align: 3
            }
      ], {
    ...
    var finalSummary = function (rpt) {
        ...
        rpt.newline();
        rpt.newline();
        rpt.print('Thank You for Choosing us!', {
            align: 'right'
        });
    };
    ...
    //var resultReport = new Report("buffer")
    var resultReport = new Report(res)
        .data(mydata)
