...
return [
    ...
    */
    ...
    'header_class' => 'app-header navbar navbar-color bg-teal border-1',
    // Barra verde - bg-teal
    // app-header navbar navbar-color bg-green border-0
    // Barra Azul
    // app-header navbar navbar-color bg-primary border-0
    ...
    'developer_name' => 'SDIN S.A.S',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'https://sdin.com.co',
    ...
    */
    ...
    //'guard' => 'backpack',
    'guard' => null, //para uso de permisos
